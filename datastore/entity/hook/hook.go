...
type ScheduleFunc func(context.Context, *entity.ScheduleMutation) (entity.Value, error)

// Mutate calls f(ctx, m).
func (f ScheduleFunc) Mutate(ctx context.Context, m entity.Mutation) (entity.Value, error) {
	mv, ok := m.(*entity.ScheduleMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *entity.ScheduleMutation", m)
	}
	return f(ctx, mv)
}
...
type ShiftFunc func(context.Context, *entity.ShiftMutation) (entity.Value, error)

// Mutate calls f(ctx, m).
func (f ShiftFunc) Mutate(ctx context.Context, m entity.Mutation) (entity.Value, error) {
	mv, ok := m.(*entity.ShiftMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *entity.ShiftMutation", m)
	}
	return f(ctx, mv)
}
