...
func (sq *ScheduleQuery) QueryShifts() *ShiftQuery {
	query := &ShiftQuery{config: sq.config}
...
func (sq *ScheduleQuery) WithShifts(opts ...func(*ShiftQuery)) *ScheduleQuery {
	query := &ShiftQuery{config: sq.config}
...
//		GroupBy(schedule.FieldSlackChannelID).
...
//
//	client.Schedule.Query().
//		Select(schedule.FieldSlackChannelID).
//		Scan(ctx, &v)
//
...
func (sq *ScheduleQuery) sqlAll(ctx context.Context) ([]*Schedule, error) {
	...
	if query := sq.withShifts; query != nil {
		...
		for i := range nodes {
			...
			nodes[i].Edges.Shifts = []*Shift{}
		}
		query.Where(predicate.Shift(func(s *sql.Selector) {
			s.Where(sql.InValues(schedule.ShiftsColumn, fks...))
		}))
		...
		for _, n := range neighbors {
			...
			node.Edges.Shifts = append(node.Edges.Shifts, n)
		}
	}
...
func (sgb *ScheduleGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("entity: ScheduleGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *ScheduleGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{schedule.Label}
	default:
		err = fmt.Errorf("entity: ScheduleGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (sgb *ScheduleGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("entity: ScheduleGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *ScheduleGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{schedule.Label}
	default:
		err = fmt.Errorf("entity: ScheduleGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (sgb *ScheduleGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("entity: ScheduleGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *ScheduleGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{schedule.Label}
	default:
		err = fmt.Errorf("entity: ScheduleGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (sgb *ScheduleGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("entity: ScheduleGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *ScheduleGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{schedule.Label}
	default:
		err = fmt.Errorf("entity: ScheduleGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *ScheduleSelect) Strings(ctx context.Context) ([]string, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("entity: ScheduleSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *ScheduleSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{schedule.Label}
	default:
		err = fmt.Errorf("entity: ScheduleSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *ScheduleSelect) Ints(ctx context.Context) ([]int, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("entity: ScheduleSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *ScheduleSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{schedule.Label}
	default:
		err = fmt.Errorf("entity: ScheduleSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *ScheduleSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("entity: ScheduleSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *ScheduleSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{schedule.Label}
	default:
		err = fmt.Errorf("entity: ScheduleSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *ScheduleSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("entity: ScheduleSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *ScheduleSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{schedule.Label}
	default:
		err = fmt.Errorf("entity: ScheduleSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
