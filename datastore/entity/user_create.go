...
func (uc *UserCreate) SetSlackHandle(s string) *UserCreate {
	uc.mutation.SetSlackHandle(s)
	return uc
}
...
func (uc *UserCreate) AddShiftIDs(ids ...int) *UserCreate {
	uc.mutation.AddShiftIDs(ids...)
	return uc
}

// AddShifts adds the "shifts" edges to the Shift entity.
func (uc *UserCreate) AddShifts(s ...*Shift) *UserCreate {
	ids := make([]int, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return uc.AddShiftIDs(ids...)
}
...
func (uc *UserCreate) check() error {
	if _, ok := uc.mutation.SlackID(); !ok {
		return &ValidationError{Name: "slack_id", err: errors.New(`entity: missing required field "User.slack_id"`)}
	}
	if _, ok := uc.mutation.SlackHandle(); !ok {
		return &ValidationError{Name: "slack_handle", err: errors.New(`entity: missing required field "User.slack_handle"`)}
	}
	...
	if _, ok := uc.mutation.AvatarURL(); !ok {
		return &ValidationError{Name: "avatar_url", err: errors.New(`entity: missing required field "User.avatar_url"`)}
	}
	if _, ok := uc.mutation.DisplayName(); !ok {
		return &ValidationError{Name: "display_name", err: errors.New(`entity: missing required field "User.display_name"`)}
	}
	if _, ok := uc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`entity: missing required field "User.created_at"`)}
	}
	if _, ok := uc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`entity: missing required field "User.updated_at"`)}
	}
	return nil
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.SlackHandle(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: user.FieldSlackHandle,
		})
		_node.SlackHandle = value
	}
	...
	if nodes := uc.mutation.ShiftsIDs(); len(nodes) > 0 {
...
// SetSlackID sets the "slack_id" field.
func (u *UserUpsert) SetSlackID(v string) *UserUpsert {
	u.Set(user.FieldSlackID, v)
	return u
}

// UpdateSlackID sets the "slack_id" field to the value that was provided on create.
func (u *UserUpsert) UpdateSlackID() *UserUpsert {
	u.SetExcluded(user.FieldSlackID)
	return u
}

// SetSlackHandle sets the "slack_handle" field.
func (u *UserUpsert) SetSlackHandle(v string) *UserUpsert {
	u.Set(user.FieldSlackHandle, v)
	return u
}

// UpdateSlackHandle sets the "slack_handle" field to the value that was provided on create.
func (u *UserUpsert) UpdateSlackHandle() *UserUpsert {
	u.SetExcluded(user.FieldSlackHandle)
	return u
}
...
// SetSlackID sets the "slack_id" field.
func (u *UserUpsertOne) SetSlackID(v string) *UserUpsertOne {
...
// UpdateSlackID sets the "slack_id" field to the value that was provided on create.
func (u *UserUpsertOne) UpdateSlackID() *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.UpdateSlackID()
	})
}
...
// SetSlackHandle sets the "slack_handle" field.
func (u *UserUpsertOne) SetSlackHandle(v string) *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.SetSlackHandle(v)
	})
}
...
// UpdateSlackHandle sets the "slack_handle" field to the value that was provided on create.
func (u *UserUpsertOne) UpdateSlackHandle() *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.UpdateSlackHandle()
	})
}
...
// SetSlackID sets the "slack_id" field.
func (u *UserUpsertBulk) SetSlackID(v string) *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.SetSlackID(v)
	})
}
...
// UpdateSlackID sets the "slack_id" field to the value that was provided on create.
func (u *UserUpsertBulk) UpdateSlackID() *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.UpdateSlackID()
	})
}
...
// SetSlackHandle sets the "slack_handle" field.
func (u *UserUpsertBulk) SetSlackHandle(v string) *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.SetSlackHandle(v)
	})
}
...
// UpdateSlackHandle sets the "slack_handle" field to the value that was provided on create.
func (u *UserUpsertBulk) UpdateSlackHandle() *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.UpdateSlackHandle()
	})
}
